...
export const sendOtpEmail = async (to, otp, userName) => {
  ...
  const fromName = process.env.SMTP_FROM_NAME || 'HRMS';
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; border: 1px solid #e5e7eb; border-radius: 12px;">
        ...
        <p style="color: #6b7280; font-size: 14px;">Use the OTP below to reset your HRMS password. It expires in <strong>10 minutes</strong>.</p>
